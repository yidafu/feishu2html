        ...
        val blocks =
            listOf(
                ...
                TextBlock(
                    ...
                    text =
                        TextBlockData(
                            elements = listOf(TextElement(textRun = TextRun(content = "Break"))),
                            style = TextStyle(align = 1),
                        ),
                ),
                BulletBlock(
        ...
        val blocks =
            listOf(
                Heading1Block(
                    ...
                    heading1 =
                        HeadingBlockData(
                            elements = listOf(TextElement(textRun = TextRun(content = "H1"))),
                            style = TextStyle(align = 1),
                        ),
                ),
                TextBlock(
    ...
    test("应该忽略PageBlock本身") {
        val pageBlock =
            PageBlock(
                ...
                page =
                    PageBlockData(
                        elements = listOf(TextElement(textRun = TextRun(content = "Page Title"))),
                        style = TextStyle(align = 1),
                    ),
            )
        ...
        val textBlock =
            TextBlock(
                ...
                text =
                    TextBlockData(
                        elements = listOf(TextElement(textRun = TextRun(content = "Body text"))),
                        style = TextStyle(align = 1),
                    ),
            )
