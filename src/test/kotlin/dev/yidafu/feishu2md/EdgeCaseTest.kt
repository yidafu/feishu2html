...
class EdgeCaseTest : FunSpec({
    ...
    test("应该正确处理包含所有元素类型的文本") {
        val elements = listOf(
            ...
            TextElement(textRun = TextRun(content = " ")),
            TextElement(textRun = TextRun(content = "Link", textElementStyle = TextElementStyle(link = Link(url = "https://example.com")))),
